import eu.profinit.sankcniseznamy.DataCleaner;
...
public class CleansingTest extends TestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        DataCleaner francis = new DataCleaner();
        entries = francis.cleanse(entries);
    ...
    {
        assertEquals(2409, entries.size());
        assertEquals(1039, totalCompanies);
        assertEquals(1237, totalEntities);
        assertEquals(133, totalUnknown);
    ...
    public void testNationalitiesList() throws Exception
    {
        ...
        assertEquals(5, nationalitiesCounts.get("Sudan").intValue());
        assertEquals(3, nationalitiesCounts.get("Malaysia").intValue());
        assertEquals(13, nationalitiesCounts.get("Syria").intValue());
        assertEquals(1, nationalitiesCounts.get("Oman").intValue());
        assertEquals(1, nationalitiesCounts.get("North Korea").intValue());
        assertEquals(9, nationalitiesCounts.get("Iran").intValue());
        assertEquals(5, nationalitiesCounts.get("Morocco").intValue());
        assertEquals(1, nationalitiesCounts.get("El Salvador").intValue());
        assertEquals(1, nationalitiesCounts.get("Mali").intValue());
        ...
        assertEquals(16, nationalitiesCounts.get("Algeria").intValue());
        assertEquals(117, nationalitiesCounts.get("Iraq").intValue());
        assertEquals(1, nationalitiesCounts.get("Slovenia").intValue());
        assertEquals(1, nationalitiesCounts.get("Cabo Verde").intValue());
        assertEquals(5, nationalitiesCounts.get("Palestinian").intValue());
        assertEquals(12, nationalitiesCounts.get("Colombia").intValue());
        assertEquals(1, nationalitiesCounts.get("Tanzania").intValue());
        assertEquals(1, nationalitiesCounts.get("Belarus").intValue());
        assertEquals(1, nationalitiesCounts.get("Afgan").intValue());
        assertEquals(3, nationalitiesCounts.get("Bahrain").intValue());
        assertEquals(1, nationalitiesCounts.get("Congo").intValue());
        assertEquals(2, nationalitiesCounts.get("India").intValue());
        assertEquals(1, nationalitiesCounts.get("Iranian national and US national/citizen").intValue());
        assertEquals(1, nationalitiesCounts.get("Canada").intValue());
        ...
        assertEquals(5, nationalitiesCounts.get("Turkey").intValue());
        assertEquals(1, nationalitiesCounts.get("Senegal").intValue());
        assertEquals(1, nationalitiesCounts.get("Italy").intValue());
        assertEquals(3, nationalitiesCounts.get("Central African Republic").intValue());
        assertEquals(2, nationalitiesCounts.get("Georgia").intValue());
        assertEquals(6, nationalitiesCounts.get("Germany").intValue());
        assertEquals(1, nationalitiesCounts.get("Ethiopia").intValue());
        assertEquals(16, nationalitiesCounts.get("Yemen").intValue());
        assertEquals(144, nationalitiesCounts.get("Afghanistan").intValue());
        assertEquals(1, nationalitiesCounts.get("Eritrea").intValue());
        assertEquals(1, nationalitiesCounts.get("Burundi").intValue());
        ...
        assertEquals(20, nationalitiesCounts.get("Egypt").intValue());
        assertEquals(7, nationalitiesCounts.get("Somalia").intValue());
        assertEquals(2, nationalitiesCounts.get("possibly Palestinian").intValue());
        assertEquals(5, nationalitiesCounts.get("Libya").intValue());
        assertEquals(8, nationalitiesCounts.get("Russia").intValue());
        assertEquals(30, nationalitiesCounts.get("Saudi Arabia").intValue());
        assertEquals(5, nationalitiesCounts.get("Filipino").intValue());
        assertEquals(1, nationalitiesCounts.get("Sweden").intValue());
        assertEquals(24, nationalitiesCounts.get("Pakistan").intValue());
        assertEquals(7, nationalitiesCounts.get("Qatar").intValue());
        assertEquals(1, nationalitiesCounts.get("China").intValue());
        assertEquals(11, nationalitiesCounts.get("Kuwait").intValue());
        ...
        assertEquals(8, nationalitiesCounts.get("Jordan").intValue());
        assertEquals(2, nationalitiesCounts.get("France").intValue());
        assertEquals(33, nationalitiesCounts.get("Tunisia").intValue());
        assertEquals(1, nationalitiesCounts.get("Kyrgyzstan").intValue());
        assertEquals(8, nationalitiesCounts.get("Philippines").intValue());
        assertEquals(5, nationalitiesCounts.get("Rwanda").intValue());
        assertEquals(4, nationalitiesCounts.get("Uzbekistan").intValue());
        assertEquals(5, nationalitiesCounts.get("United Kingdom").intValue());
        assertEquals(1, nationalitiesCounts.get("Burma").intValue());
        assertEquals(2, nationalitiesCounts.get("Kenya").intValue());
        assertEquals(2, nationalitiesCounts.get("Palestine").intValue());
        assertEquals(1, nationalitiesCounts.get("Spain").intValue());
        assertEquals(8, nationalitiesCounts.get("Lebanon").intValue());
        ...
        assertEquals(49, nationalitiesCounts.get("Mexico").intValue());
        assertEquals(2, nationalitiesCounts.get("Uganda").intValue());
        assertEquals(1, nationalitiesCounts.get("Zimbabwe").intValue());
        assertEquals(17, nationalitiesCounts.get("Indonesia").intValue());
